...
const config: ESLintConfig = {
  ...
  rules: {
    ...
    'jsx-a11y/anchor-has-content': ['warn', { components: [] }], // enforce all anchors to contain accessible content
    'jsx-a11y/anchor-is-valid': 'off', // enforce all anchors are valid, navigable elements
    'jsx-a11y/aria-activedescendant-has-tabindex': 'warn', // enforce elements with aria-activedescendant are tabbable
    ...
    'jsx-a11y/heading-has-content': 'warn', // enforce heading (h1, h2, etc) elements contain accessible content
    ...
    'jsx-a11y/no-distracting-elements': 'off', // enforce distracting elements are not used
    ...
    'jsx-a11y/no-redundant-roles': 'warn', // enforce explicit role property is not the same as implicit/default role property on element
