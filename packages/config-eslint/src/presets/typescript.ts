  ...
  overrides: [
    {
      ...
      rules: {
        ...
        '@typescript-eslint/method-signature-style': ['warn', 'property'], // enforces using a particular method signature syntax.
        '@typescript-eslint/naming-convention': [
          ...
          },
          {
            ...
            types: ['boolean'],
            format: ['PascalCase'],
            prefix: ['is', 'was', 'should', 'has', 'can', 'does', 'did', 'will', 'use', 'allow'],
            leadingUnderscore: 'forbid',
            trailingUnderscore: 'forbid',
          },
        ...
        types: ['boolean'],
        format: ['PascalCase'],
        prefix: ['is', 'was', 'should', 'has', 'can', 'did', 'will', 'use', 'allow'],
        ...
        '@typescript-eslint/no-implicit-any-catch': ['error', { allowExplicitAny: true }], // disallow usage of the implicit any type in catch clauses
        ...
        '@typescript-eslint/no-misused-promises': ['warn', { checksVoidReturn: false }], // avoid using promises in places not designed to handle them
        ...
        '@typescript-eslint/no-parameter-properties': 'warn', // disallow the use of parameter properties in class constructors
        ...
        '@typescript-eslint/no-unnecessary-qualifier': 'warn', // warns when a namespace qualifier is unnecessary
        ...
        '@typescript-eslint/return-await': 'warn', // rules for awaiting returned promises
